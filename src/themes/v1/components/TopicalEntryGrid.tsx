      ...
      <div className="max-w-container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {topicalEntryGrid.tabs[activeTab].links.map((link, index) => {
            ...
            const cardClass = "bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-all group p-6 md:p-8 flex items-center gap-5 md:gap-6"
            const inner = (
              <>
                {linkImage && (
                  <div className="flex-shrink-0 flex items-center justify-center w-24 h-24 md:w-28 md:h-28 rounded-xl bg-[#EBF3F7]">
